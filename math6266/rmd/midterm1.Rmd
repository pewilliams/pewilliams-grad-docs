...
*Exercise 6. Let $L_1, L_2$ be some subspaces in $R^n$, and $L_2 \subseteq L_1 \subseteq R^n$. Let $P_{L_1}, P_{L_2}$ denote orthogonal projections on these subspaces. Prove the following properties:*  
...
$$||P_{L_1}x - P_{L_2}|| = ||\sum_{i=p-k+1}^{p}(x \cdot u_i)u_i || \geq 0\ ,$$ and

$$||P_{L_2}x|| \leq ||P_{L_1}||= ||P_{L_1}x - P_{L_2}x + P_{L_2}x|| \leq ||P_{L_1}x - P_{L_2}x||\ ||P_{L_2}x|| $$
*(c) $PL2 \cdot PL1 = PL2$*  
