...
Second, $x \in (A \cup B) \setminus (A \cap B) \implies x \in (A \cup B)$ but not in $(A \cap B) \implies x$ is in $A$ but not $B$, or, $x$ is in $B$ but not $A \implies x \in (A \setminus B)$ or $x \in (B \setminus A) \implies x \in (A \setminus B) \cup (B \setminus A) \implies (A \setminus B ) \cup (B \setminus A) = (A \cup B ) \setminus (A \cap B)$\newline
...
(i) First, $x \in E \cap \cup_{j=1}^{n}A_j \implies x \in E\ and\ x \in \{A_1\ or\ A2\ ... or\ A_n\} \implies x \in E$ and that there exists for some $j=1,2,...,n$ an $A_j$ such that $x \in A_j\ and\ x \in E \implies (x\in E\ and\ A_1)\ or\ (x \in E\ and\ A_2)\ ...\ or\ (x \in E\ and\ A_n) \implies x \in \cup_{j=1}^{n}(E \cap A_j)$.  
...
(ii) First, $x \in E \cup \cup_{j=1}^{n} A_j \implies x \in E$ or $x \in A_1$ or $A_2$ ... or $A_n \implies$ for some $j=1,..,n$ that $x \in E \cup A_j \implies x \in E \cup A_1$ or $x \in E \cup A_2$ ... or $x \in E \cup A_n \implies x \in \cup_{j=1}^{n} (E \cup A_j)$. 
...
(i) First, $x \in \cap \cap_{j=1}^{n}A_j \implies x \in E$ and $x \in \cap_{j=1}^{n} A_j \implies x \in E\ and\ x \in A_j$ for all $j = 1,..,n  \implies x \in E$ and $[x \in A_1\ and\ x \in A_2\ ...\ and\ x \in A_n] \implies [x \in E\ and\ A_1]$ and ... and $[x \in E\ and\ A_n] \implies x \in \cap_{j=1}^{n} (E \cap A_j)$.
...
(ii) First, $x \in E \cup \cap_{j=1}^{n}A_j \implies x \in E$ or $x \in \cap_{j=1}^{n} A_j \implies x \in E$ or $[x \in A_1$ and $x \in A_2$ ... and $x \in A_n] \implies x \in E\ or\ A_1\ and\ x \in E\ or\ A_2\ ...\ and\ x \in E\ or\ A_n \implies x \in \cap_{j=1}^{n}(E \cup A_j)$.
