...
Notes: The fact that every infinite set has denumberable $implies$ there exists a bijective function that maps a proper subset of an infinite set, $B$, onto $\mathbb{N}$. One-one correspondence implies injection from proper subset $B$
