...
---------------Notes: The fact that every infinite set has a denumberable subset $implies$ there exists a bijective function that maps a proper subset of an infinite set, $B$, onto $\mathbb{N}$. One-one correspondence implies injection from proper subset $B$ solution in back (need to check)
