...
*G. Prove the Canton Intersection Theormem by selecting a point $x_n$ from $F_n$ and then applying the Bolzano-Weierstrass Theorem 10.6 to the set $\{x_n: n \in \mathbb{N}\}$.*   
