...
#### Section 10
*C. A point $x$ is a cluster point of a set $A \subseteq \mathbb{R}^p$ if and only if every neighborhood of $x$ contains infinitely man points of $A$.*
...
*G. Show that every point in the Canton set $F is a cluster point of both $F$ and the complement of $F$,$F^c$.*
