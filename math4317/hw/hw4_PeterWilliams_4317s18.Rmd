...
Domain compact, sequence uniformly equicontinuous but not bounded
(b) $f_n(x)  = x^n,\ x \in [0,1]$;  
Domain compact, sequence bounded by not uniformly equicontinuous.
(c) $f_n(x) = \frac{1}{1 + (x -n )^2},\ x \in [0,+\infty)$.  
Domain not compact, sequence bounded, and uniformly continuous
